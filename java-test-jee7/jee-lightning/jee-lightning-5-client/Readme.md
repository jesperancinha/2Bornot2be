...
This is the client for project [jee-lightning-5](../jee-lightning-5).
...
- [WildFly remote EJB client tutorial @ mastertheboss.com](http://www.mastertheboss.com/jboss-server/jboss-as-7/jboss-as-7-remote-ejb-client-tutorial)
