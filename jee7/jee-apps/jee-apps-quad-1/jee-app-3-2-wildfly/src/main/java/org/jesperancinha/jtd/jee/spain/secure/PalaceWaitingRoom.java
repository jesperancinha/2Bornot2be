...
public class PalaceWaitingRoom implements Serializable {
    ...
    public boolean isUserInRole(String roleName) {
        if (Objects.isNull(contextProvider)) {
            printYellowGenericLn("The context provider session is null");
            printYellowGenericLn("You probably call this from a JSP");
            printYellowGenericLn("Try now using the REST service");
            return false;
        }
        try {
