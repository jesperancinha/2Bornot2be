...
public class EventProcessor implements Serializable {
    ...
    public void informFamily(
        @Observes(notifyObserver = IF_EXISTS, during = AFTER_COMPLETION)
            ArrivalEvent event) {
    ...
    public void orderFlowers(
        @Observes(notifyObserver = IF_EXISTS, during = BEFORE_COMPLETION)
            ArrivalEvent event) {
    ...
    public void arrangeGarden(
        @Observes(notifyObserver = IF_EXISTS, during = AFTER_SUCCESS)
            ArrivalEvent event) {
