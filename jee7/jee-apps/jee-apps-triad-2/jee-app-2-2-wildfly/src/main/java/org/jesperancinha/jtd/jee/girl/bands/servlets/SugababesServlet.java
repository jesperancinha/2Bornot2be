...
import static org.jesperancinha.console.consolerizer.Consolerizer.getUnicorns;
...
public class SugababesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Consolerizer.printGreenGenericLn(NOTE_THAT_BOTH_FILTERS_WERE_ABLE_TO_WRITE_OUTPUT);
        Consolerizer.printGreenGenericLn(
