...
<p><%=simpleLyricBean.getArtist()%></p>
<p><%=simpleLyricBean.getLyrics()%></p>

<h2>This is the typed version. We can access superLyrics</h2>
<p><%=simpleLyricBean2.getArtist()%></p>
<p><%=simpleLyricBean2.getLyrics()%></p>
<p><%=simpleLyricBean2.superLyrics()%></p>
