CREATE TABLE IF NOT EXISTS USERS_PRIDE (login VARCHAR(64) PRIMARY KEY,passwd VARCHAR(64));
CREATE TABLE IF NOT EXISTS USER_ROLES_PRIDE(login VARCHAR(64), role VARCHAR(32));
DELETE from USER_ROLES_PRIDE;
DELETE from USERS_PRIDE;
