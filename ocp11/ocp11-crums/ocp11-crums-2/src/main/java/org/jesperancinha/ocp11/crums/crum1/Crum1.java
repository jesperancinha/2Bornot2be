...
public class Crum1 {
    public static void main(String[] args) {
        ...
        printMagentaGenericLn("If a < 10 or b < 20 or c < 30, we cannot calculate our int average -> %d", average(3,4,5));
        printMagentaGenericLn("If a >= 10 and b >= 20 and c >=30, we can calculate our int average -> %d", average(10,20,30));
        printMagentaGenericLn("If all three parameters are long, we can still calculate it -> %d", average(3L,4L,5L));

        printGreenGenericLn("We cannot have var parameters and so overloading or overriding is never possible with parameters var.");
    }
