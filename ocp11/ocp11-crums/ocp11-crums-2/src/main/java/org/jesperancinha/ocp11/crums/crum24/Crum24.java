package org.jesperancinha.ocp11.crums.crum24;
...
public class Crum24 {
    ...
    public static void main(String[] args) {
        ...
        printMagentaGeneric("Overriding means that after compilation, there is only the most specific method available");
        ...
        printMagentaGenericLn("By creating Hurray, we will overrice the Happy method and thus even with casting,\nthis will result in the sane Hurray method");
        ...
        printMagentaGenericLn("By creating a Party, we will override the Happy method and the Hurray method and thus even with casting,\nthis will result in the same Party method");
        party1.showParty();
        hurray2.showParty();
        happy3.showParty();
