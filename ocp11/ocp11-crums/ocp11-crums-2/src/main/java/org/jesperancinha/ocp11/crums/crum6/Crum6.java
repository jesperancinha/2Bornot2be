...
public class Crum6 {
    public static void main(String[] args) {
        ...
        if(Objects.isNull(console)){
            printBrightMagentaGenericLn("No console found! Please run this program from the command line to be able to exercise Crum6");
        } else {
            ...
            printGreenGenericLn("Our console always has `readPassword`, `readLine`, a `writer`, a `reader` and we can write to the output via `format`");
        }
    }
}
